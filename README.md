...
**באייפון** חובה להוסיף את Navi למסך הבית (שיתוף ← הוסף למסך הבית) ולפתוח משם:
Safari מוחק אחסון של אתר רגיל אחרי שבעה ימים בלי שימוש, ואפליקציות מסך הבית פטורות.
